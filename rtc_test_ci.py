...
def send_message_to_symphony(subject, body, webhook):
    ...
    print('send_message_to_symphony, webhook: ' + webhook)
    print('send_message_to_symphony, data: ' + data)
...
def create_link(link):
    return '<a href=\"https://' + urllib.parse.quote(link[8:]) + '\" />'
...
url = 'https://jenkins.rtc.dev.symphony.com/view/FE/job/'
job_name =  'SFE-RTC'
job_name2 = 'Daily E2E CI St2 C1'
